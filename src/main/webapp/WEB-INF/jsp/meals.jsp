...
<script src="resources/js/datatablesUtil.js" type="text/javascript" defer></script>
<script src="resources/js/mealDatatables.js" type="text/javascript" defer></script>
                ...
                <table class="table table-striped" id="datatable">
                    ...
                    <c:forEach items="${meals}" var="meal">
                        ...
                        <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                            ...
                            <td><a href="meals/delete?id=${meal.id}"><span class="glyphicon glyphicon-remove"></span></a></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
